...
//  SpacePix
//
//  Updated by by Sebastien Schaeffler on 04/06/16.
...
struct DeviceUtils {
    ...
    static func isOrientationLandscape() -> Bool {
        return (getOrientation() == UIDeviceOrientation.LandscapeLeft || getOrientation() == UIDeviceOrientation.LandscapeRight)
    }
    
    static func isOrientationPortrait() -> Bool {
        return (getOrientation() == UIDeviceOrientation.Portrait || getOrientation() == UIDeviceOrientation.PortraitUpsideDown)
    }
}
